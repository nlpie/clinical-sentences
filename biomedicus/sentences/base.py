...
from typing import Tuple, AnyStr, Union, Dict, List, Optional, Iterable
...
class SentenceDetector(object):
    ...
    def train_on_data(self, data, sample_weights, targets, job_dir):
        ...
        if self.early_stopping:
            stopping = keras.callbacks.EarlyStopping(patience=self.early_stopping_patience,
...
class _Metrics(keras.callbacks.Callback):
